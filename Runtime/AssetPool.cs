...
namespace VAT.Pooling {
    public class AssetPool {
        ...
        private SpawnableContent _content;
        ...
        public AssetPool(SpawnableContent content, Transform rootTransform = null) {
            ...
            if (_content.MainGameObject != null)
                _content.MainGameObject.LoadAsset(OnAssetLoaded);
        }
        ...
        protected virtual AssetPoolable Internal_Instantiate(bool isActive = false)
        {
            ...
            GameObject go = GameObject.Instantiate(_content.MainGameObject.Asset, _tempParent);
