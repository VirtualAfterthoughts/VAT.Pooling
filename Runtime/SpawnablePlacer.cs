    ...
    public sealed class SpawnablePlacer : MonoBehaviour, ITriggerable {
        ...
        private void OnDrawGizmos() {
            ...
            if (_spawnable.contentReference != null && _spawnable.contentReference.TryGetContent(out var content)) {
                ...
                if (content.MainGameObject != null && content.MainGameObject.EditorAsset != null) {
                    var go = content.MainGameObject.EditorAsset;
            ...
            if (questionMark != null) {
                ...
                Debug.LogError("Missing Cryst editor asset: \"Resources/Unknown Spawnable\"");
            }
        }
#endif
    }
